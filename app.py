...
def descargar_dataset_real():
    # Ruta robusta: busca el CSV en la misma carpeta que app.py
    base_dir = os.path.dirname(os.path.abspath(__file__))
    archivo_local = os.path.join(base_dir, "Tweets.csv")
    ...
    try:
        ...
        for campo in ["Ciudad", "Aeropuerto", "Region", "Latitud", "Longitud"]:
            df_clean[campo] = df_clean["Airline"].map(
                lambda x, c=campo: mapa_ubicaciones.get(x, {}).get(c, None)
            )

        df_clean["Ciudad"] = df_clean["Ciudad"].fillna("Sin ubicación")
        df_clean["Aeropuerto"] = df_clean["Aeropuerto"].fillna("N/D")
        df_clean["Region"] = df_clean["Region"].fillna("Sin región")
        ...
        st.error(
            f"No se encontró el archivo 'Tweets.csv'. "
...
def agregar_puntos_globales_simulados(df):
    ...
    puntos_globales = [
        {"Airline": "British Airways", "Ciudad": "Londres", "Aeropuerto": "LHR", "Region": "Europa", "Latitud": 51.4700, "Longitud": -0.4543},
        {"Airline": "Air France", "Ciudad": "París", "Aeropuerto": "CDG", "Region": "Europa", "Latitud": 49.0097, "Longitud": 2.5479},
        {"Airline": "Lufthansa", "Ciudad": "Frankfurt", "Aeropuerto": "FRA", "Region": "Europa", "Latitud": 50.0379, "Longitud": 8.5622},
        {"Airline": "Emirates", "Ciudad": "Dubái", "Aeropuerto": "DXB", "Region": "Asia / Medio Oriente", "Latitud": 25.2532, "Longitud": 55.3657},
        {"Airline": "Qatar Airways", "Ciudad": "Doha", "Aeropuerto": "DOH", "Region": "Asia / Medio Oriente", "Latitud": 25.2731, "Longitud": 51.6081},
        {"Airline": "Singapore Airlines", "Ciudad": "Singapur", "Aeropuerto": "SIN", "Region": "Asia", "Latitud": 1.3644, "Longitud": 103.9915},
        {"Airline": "LATAM", "Ciudad": "Santiago de Chile", "Aeropuerto": "SCL", "Region": "América del Sur", "Latitud": -33.3928, "Longitud": -70.7858},
        {"Airline": "Aerolíneas Argentinas", "Ciudad": "Buenos Aires", "Aeropuerto": "EZE", "Region": "América del Sur", "Latitud": -34.8222, "Longitud": -58.5358},
        {"Airline": "Qantas", "Ciudad": "Sídney", "Aeropuerto": "SYD", "Region": "Oceanía", "Latitud": -33.9399, "Longitud": 151.1753},
        {"Airline": "Air New Zealand", "Ciudad": "Auckland", "Aeropuerto": "AKL", "Region": "Oceanía", "Latitud": -37.0082, "Longitud": 174.7850}
    ]
...
with st.spinner("Leyendo y preprocesando dataset..."):
...
with tab_resumen:
    ...
    col1.metric(label="Tweets Analizados", value=total_menciones)
    col2.metric(
        label="Negativos",
        value=negativos,
    ...
    col5.metric(label="Riesgo", value=riesgo_crisis)
